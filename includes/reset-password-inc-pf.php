<?php
  ...
  if (isset($_POST["reset-password-submit"])) {
    ...
    $url = "https://www.hagile.com.br/projetos/teste-sistema-matheus/pessoa-fisica/complexo-seguro/create-new-password-pf.php?selector=" . $selector . "&validator=" . bin2hex($token);
